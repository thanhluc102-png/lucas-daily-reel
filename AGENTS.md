...
1. Đọc `rules/editorial.md`, `rules/visual.md` và `rules/imagery.md`. Luôn đọc, kể cả khi thấy quen.
...
- **Không dùng ảnh AI để vẽ sản phẩm đang bán.** Ảnh sản phẩm luôn là `product_image` lấy từ WooCommerce. Xem `rules/imagery.md`.
...
rules/imagery.md       quy tắc ảnh AI — cấm vẽ sản phẩm, cách viết prompt
