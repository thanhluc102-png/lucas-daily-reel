...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  const durations = { hook: 15, premium: 16 };
  ...
  html = html.replace(
    '<!--AUDIO-->',
    hasBgm
      ? `<audio id="bgm" data-timeline-role="music" data-start="0" data-duration="${durations[name]}" data-track-index="1" data-volume="0.35" src="assets/bgm.mp4"></audio>`
      : ''
  );
